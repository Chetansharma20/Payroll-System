  ...
  const SubmitSalaryHeads = async (e) => {
    ...
    try {
      const result = await axios.post(
        'http://localhost:5000/api/addsalarysettings', {  ...reqData,CompanyId: companyData._id,} );
      console.log(result.data);
      alert('Salary settings added');
  ...
  useEffect(()=> 
    {
      ...
      {
        let result = await axios.post("http://localhost:5000/api/fetchsalarysettingsbyemployee", {CompanyId: companyData._id})
        console.log(result)
